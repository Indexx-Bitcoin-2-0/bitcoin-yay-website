...
const PaymentSuccessPopup: React.FC<PaymentSuccessPopupProps> = ({
    ...
    const displayPlanName = planName ?? "Turbo Mining";
            ...
            <div className="w-90 md:w-120 lg:w-140 p-6 md:p-8 xl:p-10 text-center">
                ...
                <div className="flex flex-col items-center justify-center mb-8">
                    ...
                    <p className="text-base md:text-lg text-gray-400">
                        You have successfully subscribed to {displayPlanName}.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center justify-center gap-4 md:flex-row md:gap-6 mt-6">
                    <CustomButton2
                        text="Got it"
                        onClick={onClose}
