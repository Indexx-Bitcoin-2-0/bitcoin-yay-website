...
import AmericanFlag from "@/assets/images/art.png";

// BTCY Independence Week (4th of July) promo banner. Rendered inside the home
// page banner slider (src/components/HomeBannerSlider.tsx).
const OFFERS = [
  { Icon: Rocket, text: "30% Bonus on Quantum Mining", accent: true },
  { Icon: Zap, text: "20% OFF on Power Mining", accent: false },
  { Icon: Target, text: "Bet on EMMM → 30% OFF Power Mining", accent: true },
];

const IndependenceWeekBanner = () => {
  return (
      ...
      <div className="relative mt-6 flex flex-col items-center gap-6 md:flex-row">
        ...
        <div className="flex flex-[1.4] flex-col p-6 md:p-8">
          ...
          <h1 className="mb-5 text-4xl font-bold uppercase leading-[0.95] tracking-tight text-white md:text-6xl">
            Independence
            <br />
            <span className="text-[#f28132]">Week Sale</span>
          </h1>

          {/* Offers */}
          <div className="mb-5 flex flex-col gap-3">
            {OFFERS.map(({ Icon, text, accent }) => (
              <div key={text} className="flex items-center gap-3">
                ...
                />
                <p
                  className={`text-sm font-bold uppercase tracking-wide md:text-base ${accent ? "text-[#f28132]" : "text-white"
                    }`}
                >
                  {text}
                </p>
        ...
        {/* Right Section - Flag illustration */}
        <div className="flex flex-1 items-center justify-center md:justify-end">
          <Image
            src={AmericanFlag}
            alt="Independence Week"
...
export default IndependenceWeekBanner;
