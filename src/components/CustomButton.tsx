...
const CustomButton = ({
  ...
  return (
    <div
      className={
        "relative text-sm md:text-lg font-normal md:p-0 w-fit bg-transparent flex items-center justify-center text-center cursor-pointer hover:text-primary"
      }
    ...
    >
      ...
      <p
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-xs md:text-lg  ${
