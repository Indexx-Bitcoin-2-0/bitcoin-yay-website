    ...
    <div className=" mx-auto max-w-[90vw] lg:px-10 py-8">
      ...
      <div className="my-40">
        <p className="text-sm md:text-lg font-normal text-tertiary my-4">
          ...
          Policy (“Policy”) outlines how we collect, use, share, and store data
          from users of the Bitcoin Yay website, mobile applications, and
          services (collectively, the “Services”).
        </p>
        <p className="text-sm md:text-lg font-normal text-tertiary my-4">
          By accessing or using our Services, you agree to the terms of this
          Policy and our [Terms of Use], and you consent to our collection, use,
          disclosure, and retention of your information as described herein. If
          you do not agree with any part of this Privacy Policy or our Terms of
          Use, please refrain from using our Services.
        </p>
        <p className="text-sm md:text-lg font-normal text-tertiary my-4">
        ...
        content={
          <>
            ...
            <li>
              ...
              web beacons, and tracking technologies when you use our Services.
            </li>
            <li>
      ...
      <InfoSection
        ...
        content={
          <>
            ...
            <li>
              User-Generated Content – Messages, comments, reactions, and media
              shared in forums or community spaces.
            </li>
            <li>
