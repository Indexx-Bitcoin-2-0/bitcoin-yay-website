      ...
      <div className="flex flex-col items-center justify-center gap-20">
        ...
        <div className="mt-20 flex flex-col items-center justify-center gap-4">
          ...
          <ul className="mt-20 list-disc list-inside text-xl flex flex-col gap-6 max-w-[400px]">
            ...
            <li>Enjoy 9× more tokens than the 1.5 BTCY free plan for faster overall growth.</li>
          </ul>
        </div>
        <div className="flex flex-col items-center gap-6 w-full">
          <div className="w-full max-w-md text-left" ref={durationDropdownRef}>
            <label className="block text-sm text-tertiary mb-2" htmlFor="nuclear-duration">
              Plan Type
            </label>
          ...
          <div className="w-full max-w-md text-left">
            <label className="text-sm text-tertiary" htmlFor="nuclear-coupon">
          ...
          <CustomButton2
            ...
            imageStyling="w-34"
            ariaLabel="Open Nuclear Mining payment options"
            disabled={
              isSubmitting ||
