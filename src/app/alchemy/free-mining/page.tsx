          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center w-full max-w-120">
              <div className="relative flex w-full">
                ...
                <Link
                  href="#"
                  className="absolute right-1 top-1 bottom-1 px-6 py-2 md:px-8 md:py-3 bg-[#6B6B6B] hover:bg-[#5A5A5A] text-white font-semibold rounded-full transition-colors duration-200 text-base md:text-lg font-boldwhitespace-nowrap"
                >
                  ACTION
                </Link>
              </div>
