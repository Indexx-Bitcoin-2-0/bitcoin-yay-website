    ...
    <div className="mx-auto mt-40">
      ...
      <SectionDiv id="mining-participation-model">
        ...
        <CustomPWithTitle2
          ...
          content="Entry-level free mining with minimal commitment, allowing anyone to start earning BTCY at no cost. Base speed is 1× (earning ~1.5 BTCY/hour initially). While free, users may need to perform small in-app tasks like viewing ads or providing feedback to maintain rewards. This onboards anyone at zero cost and ensures engagement."
        />
        <CustomPWithTitle2
        ...
        <CustomUnorderedList>
          ...
          <CustomListItem2
            ...
            content="3× speed (~4.5 BTCY/hour) for $100/month. Perks include faster transaction processing on the network."
          />
          <CustomListItem2
        ...
        <CustomPWithTitle2
          ...
          content="9× speed (~13.5 BTCY/hour) for $600/month. Offers ultra-speed mining and VIP support (dedicated customer service, faster issue resolution, and exclusive community perks). Nuclear users are major financial supporters of the network and reap the highest base rewards (nine times the free rate)."
        />
        <CustomPWithTitle2
